<?php
/**
 * Gallery Engine - Pure business logic for gallery operations
 *
 * Framework-agnostic class that handles:
 * - Querying posts by taxonomy or category
 * - Extracting attachments
 * - Building gallery HTML
 * - Building EXIF captions
 *
 * No WordPress hooks, no block registration, no asset enqueueing.
 * Just pure gallery logic that can be reused anywhere.
 */

if ( ! defined( 'ABSPATH' ) ) { exit; }

class Gallery_Engine {
